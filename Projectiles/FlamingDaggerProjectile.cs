...
{
    public class FlamingDaggerProjectile : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            if (Main.rand.Next(0, 3) == 1)
            {
                ...
                {
                    Item.NewItem(Projectile.GetSource_Death(), Projectile.getRect(), Mod.Find<ModItem>("FlamingDagger").Type);
                }
                else
                {
        ...
        public override void AI()
        {
            ...
            {
                int dust = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.FlameBurst, Projectile.velocity.X / 5, Projectile.velocity.Y / 5, default, default, Main.rand.NextFloat(0.75f, 1.25f));
        ...
        {
            if (Main.rand.NextBool(2)) target.AddBuff(BuffID.OnFire, 60 * 1);
        }
